...
export class FastCryptoAPI implements ICryptoAPI {
    ...
    private cryptoInstance: SubtleCrypto | null = null;
     ...
     */
    private async pbkdf2(strPassword: string, salt: string, hash: string,
    ...
    canDerive(): Promise<Boolean> {
        try {
            ...
            return Promise.resolve(this.cryptoInstance != null);
        } catch(e) {
